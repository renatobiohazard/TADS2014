#Questão 3) Escreva um programa que leia 10 números e mostre-os na ordem em que foram lidos, dizendo se o número é par ou ímpar.
.data
  .word 0  #0x10010000
  .word 0  #0x10010004
  .word 0  #0x10010008
...
laco:  beq $20, $21, sai_for #verifica se o valor do registrador $20 é igual ao do $21, não sendo  passa direto, sendo ele pula pro fim do for.
       ...
       div  $4,$19	#dividir o valor do registrador $4 por $19 com o resto no HI
