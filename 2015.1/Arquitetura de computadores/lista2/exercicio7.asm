#Questão 7) Escreva um programa que leia 10 números, armazenando-os em um array e mostre o maior e o menor número e em que índice do array ele se encontram.
.data
  .word 0  #0x10010000
  .word 0  #0x10010004
  .word 0  #0x10010008
