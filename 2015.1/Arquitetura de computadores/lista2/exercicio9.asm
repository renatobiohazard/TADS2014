#Questão 9) Escreva um programa que leia 20 números, armazenando-os em um array e troque de lugar o primeiro com o último, o segundo com o penúltimo, etc... Ao final, mostre o array resultante.
.data
  .word 0  #0x10010000
  .word 0  #0x10010004
  .word 0  #0x10010008
...
lui  $8, 0x1001 #registrador que guarda meu primeiro endereço de memória
