#Questão 2) Escreva um programa que leia 10 números e mostre-os na ordem inversa a que foram lidos.
.data
  .word 0  #0x10010000
  .word 0  #0x10010004
  .word 0  #0x10010008
...
main:  lui  $7, 0x1001 #registrador que guarda meu primeiro endereço de memória
       ...
       addi  $7,$7,36  #adiciona 36 ao registrador que guarda a memoria iniciar, apra depois diminuir desse valor
